    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Here is a summary of today's traffic enforcement activity.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="shadow-sm flex flex-col">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">Fines Collected (Today)</CardTitle>
            ...
            <CardContent className="flex-grow">
              ...
              <p className="text-sm text-muted-foreground mt-1">+15.2% from yesterday</p>
            </CardContent>
            <CardFooter>
              <Button
                variant="outline"
          ...
          <Card className="shadow-sm flex flex-col">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">New Fines Issued (Today)</CardTitle>
              <div className="p-2 bg-primary/10 rounded-lg">
            ...
            <CardContent className="flex-grow">
              ...
              <p className="text-sm text-muted-foreground mt-1">+5% from yesterday</p>
            </CardContent>
            <CardFooter>
              <Button
                variant="outline"
          ...
          <Card className="shadow-sm flex flex-col">
            ...
            <CardContent className="flex-grow">
              ...
              <p className="text-sm text-muted-foreground mt-1">3 new since yesterday</p>
            </CardContent>
            <CardFooter>
              <Button
                variant="outline"
          ...
          <Card className="shadow-sm flex flex-col">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">Total Outstanding Fines</CardTitle>
              <div className="p-2 bg-primary/10 rounded-lg">
            ...
            <CardContent className="flex-grow">
              ...
              <p className="text-sm text-muted-foreground mt-1">Total value: N$250,600</p>
            </CardContent>
            <CardFooter>
              <Button
                variant="outline"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <Card className="lg:col-span-2 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>Daily fines issued this week</CardDescription>
            </CardHeader>
            <CardContent>
              <FinesChart />
            </CardContent>
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <CardDescription>Latest fines, payments, and disputes</CardDescription>
            </CardHeader>
            <CardContent>
